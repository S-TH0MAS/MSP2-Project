...
const { getDevRoleName } = require('./dev-role');

const OPEN_LOCK_MODAL = 'open_lock_modal';

function buildLockPanelContent() {
    const devRole = getDevRoleName();
    ...
    return [
        ...
        '',
        `_Réservé au rôle **${devRole}** — vos actions restent visibles uniquement par vous._`,
    ].join('\n');
}
